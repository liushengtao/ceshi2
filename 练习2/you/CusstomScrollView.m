...
@implementation CusstomScrollView
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _scrollView.contentSize = CGSizeMake(self.bounds.size.width*4 , 50);
...
//        _pageControl = [[UIPageControl alloc] initWithFrame:CGRectMake(self.width -100, self.height -20, 100, 20)];
        _pageControl = [[UIPageControl alloc] initWithFrame:CGRectMake(self.frame.size.width -100, self.frame.size.height -20, 100, 20)];
    }
...
- (void)setDataource:(id<CusstomScrollViewDatasource>)datasource
{
